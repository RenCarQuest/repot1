...
class $AssetsBackgroundGen {
  ...
  /// File path: assets/background/drawer_background.png
  AssetGenImage get drawerBackground =>
      const AssetGenImage('assets/background/drawer_background.png');
...
class $AssetsClipartGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [confirm];
}
...
class $AssetsIconGen {
  ...
  /// List of all assets
  List<dynamic> get values => [sample, search];
}
